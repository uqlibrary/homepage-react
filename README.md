...
- You must always merge your change to master branch, and then merge master into staging/production branches (ideally, merge you changes into staging branch and make sure [e2e tests](https://github.com/uqlibrary/e2e-testing) pass **before** merging then into master branch)
