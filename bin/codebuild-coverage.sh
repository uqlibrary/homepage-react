...
cp "${CODEBUILD_SRC_DIR_TestArtifact1}/coverage/playwright/coverage-final-*.json" coverage/all/
cp "${CODEBUILD_SRC_DIR_TestArtifact2}/coverage/playwright/coverage-final-*.json" coverage/all/
