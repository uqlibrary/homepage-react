...
// Team list manage
export const TESTTAG_TEAM_LIST_LOADING = 'TESTTAG_TEAM_LIST_LOADING';
export const TESTTAG_TEAM_LIST_LOADED = 'TESTTAG_TEAM_LIST_LOADED';
export const TESTTAG_TEAM_LIST_FAILED = 'TESTTAG_TEAM_LIST_FAILED';
export const TESTTAG_TEAM_LIST_LOAD_CLEAR_ERROR = 'TESTTAG_TEAM_LIST_LOAD_CLEAR_ERROR';
export const TESTTAG_TEAM_LIST_UPDATING = 'TESTTAG_TEAM_LIST_UPDATING';
export const TESTTAG_TEAM_LIST_UPDATED = 'TESTTAG_TEAM_LIST_UPDATED';
export const TESTTAG_TEAM_LIST_UPDATE_CLEAR_ERROR = 'TESTTAG_TEAM_LIST_UPDATE_CLEAR_ERROR';
export const TESTTAG_TEAM_LIST_UPDATE_FAILED = 'TESTTAG_TEAM_LIST_UPDATE_FAILED';
export const TESTTAG_TEAM_LIST_ADDING = 'TESTTAG_TEAM_LIST_ADDING';
export const TESTTAG_TEAM_LIST_ADDED = 'TESTTAG_TEAM_LIST_ADDED';
export const TESTTAG_TEAM_LIST_ADD_FAILED = 'TESTTAG_TEAM_LIST_ADD_FAILED';
export const TESTTAG_TEAM_LIST_DELETING = 'TESTTAG_TEAM_LIST_DELETING';
export const TESTTAG_TEAM_LIST_DELETED = 'TESTTAG_TEAM_LIST_DELETED';
export const TESTTAG_TEAM_LIST_DELETE_FAILED = 'TESTTAG_TEAM_LIST_DELETE_FAILED';
export const TESTTAG_TEAM_LIST_CLEAR_ERROR = 'TESTTAG_TEAM_LIST_CLEAR_ERROR';

// Printer template list manage
export const TESTTAG_PRINTER_TEMPLATE_LIST_LOADING = 'TESTTAG_PRINTER_TEMPLATE_LIST_LOADING';
export const TESTTAG_PRINTER_TEMPLATE_LIST_LOADED = 'TESTTAG_PRINTER_TEMPLATE_LIST_LOADED';
export const TESTTAG_PRINTER_TEMPLATE_LIST_FAILED = 'TESTTAG_PRINTER_TEMPLATE_LIST_FAILED';
export const TESTTAG_PRINTER_TEMPLATE_LIST_LOAD_CLEAR_ERROR = 'TESTTAG_PRINTER_TEMPLATE_LIST_LOAD_CLEAR_ERROR';
export const TESTTAG_PRINTER_TEMPLATE_LIST_UPDATING = 'TESTTAG_PRINTER_TEMPLATE_LIST_UPDATING';
export const TESTTAG_PRINTER_TEMPLATE_LIST_UPDATED = 'TESTTAG_PRINTER_TEMPLATE_LIST_UPDATED';
export const TESTTAG_PRINTER_TEMPLATE_LIST_UPDATE_CLEAR_ERROR = 'TESTTAG_PRINTER_TEMPLATE_LIST_UPDATE_CLEAR_ERROR';
export const TESTTAG_PRINTER_TEMPLATE_LIST_UPDATE_FAILED = 'TESTTAG_PRINTER_TEMPLATE_LIST_UPDATE_FAILED';
export const TESTTAG_PRINTER_TEMPLATE_LIST_ADDING = 'TESTTAG_PRINTER_TEMPLATE_LIST_ADDING';
export const TESTTAG_PRINTER_TEMPLATE_LIST_ADDED = 'TESTTAG_PRINTER_TEMPLATE_LIST_ADDED';
export const TESTTAG_PRINTER_TEMPLATE_LIST_ADD_FAILED = 'TESTTAG_PRINTER_TEMPLATE_LIST_ADD_FAILED';
export const TESTTAG_PRINTER_TEMPLATE_LIST_DELETING = 'TESTTAG_PRINTER_TEMPLATE_LIST_DELETING';
export const TESTTAG_PRINTER_TEMPLATE_LIST_DELETED = 'TESTTAG_PRINTER_TEMPLATE_LIST_DELETED';
export const TESTTAG_PRINTER_TEMPLATE_LIST_DELETE_FAILED = 'TESTTAG_PRINTER_TEMPLATE_LIST_DELETE_FAILED';
export const TESTTAG_PRINTER_TEMPLATE_LIST_CLEAR_ERROR = 'TESTTAG_PRINTER_TEMPLATE_LIST_CLEAR_ERROR';
export const TESTTAG_PRINTER_TEMPLATE_PASTE_DETECTED = 'TESTTAG_PRINTER_TEMPLATE_PASTE_DETECTED';
export const TESTTAG_PRINTER_TEMPLATE_PASTE_CLEAR = 'TESTTAG_PRINTER_TEMPLATE_PASTE_CLEAR';
...
export const DLOR_DEMOGRAPHICS_LOADING = 'DLOR_DEMOGRAPHICS_LOADING';
export const DLOR_DEMOGRAPHICS_LOADED = 'DLOR_DEMOGRAPHICS_LOADED';
export const DLOR_DEMOGRAPHICS_FAILED = 'DLOR_DEMOGRAPHICS_FAILED';

export const DLOR_FAVOURITES_LOADING = 'DLOR_FAVOURITES_LOADING';
export const DLOR_FAVOURITES_LOADED = 'DLOR_FAVOURITES_LOADED';
export const DLOR_FAVOURITES_FAILED = 'DLOR_FAVOURITES_FAILED';
export const DLOR_FAVOURITES_UPDATED = 'DLOR_FAVOURITES_UPDATED';
export const DLOR_FAVOURITES_CLEARED = 'DLOR_FAVOURITES_CLEARED';

export const DLOR_ADMIN_NOTES_LOADING = 'DLOR_ADMIN_NOTES_LOADING';
export const DLOR_ADMIN_NOTES_LOADED = 'DLOR_ADMIN_NOTES_LOADED';
export const DLOR_ADMIN_NOTES_FAILED = 'DLOR_ADMIN_NOTES_FAILED';

export const DLOR_ADMIN_NOTES_CLEAR = 'DLOR_ADMIN_NOTES_CLEAR';

export const DLOR_KEYWORDS_LOADING = 'DLOR_KEYWORDS_LOADING';
export const DLOR_KEYWORDS_LOADED = 'DLOR_KEYWORDS_LOADED';
export const DLOR_KEYWORDS_FAILED = 'DLOR_KEYWORDS_FAILED';

export const DLOR_KEYWORDS_UPDATING = 'DLOR_KEYWORDS_UPDATING';
export const DLOR_KEYWORDS_UPDATED = 'DLOR_KEYWORDS_UPDATED';
export const DLOR_KEYWORDS_UPDATE_FAILED = 'DLOR_KEYWORDS_UPDATE_FAILED';

export const DLOR_STATISTICS_FAILED = 'DLOR_STATISTICS_FAILED';
export const DLOR_STATISTICS_LOADED = 'DLOR_STATISTICS_LOADED';
export const DLOR_STATISTICS_LOADING = 'DLOR_STATISTICS_LOADING';

export const DLOR_SCHEDULE_FAILED = 'DLOR_SCHEDULE_FAILED';
export const DLOR_SCHEDULE_LOADED = 'DLOR_SCHEDULE_LOADED';
export const DLOR_SCHEDULE_LOADING = 'DLOR_SCHEDULE_LOADING';

export const DLOR_DASHBOARD_LOADING = 'DLOR_DASHBOARD_LOADING';
export const DLOR_DASHBOARD_LOADED = 'DLOR_DASHBOARD_LOADED';
export const DLOR_DASHBOARD_FAILED = 'DLOR_DASHBOARD_FAILED';
...
export const SPACES_ROOM_LIST_LOADING = 'SPACES_ROOM_LIST_LOADING';
export const SPACES_ROOM_LIST_FAILED = 'SPACES_ROOM_LIST_FAILED';
export const SPACES_ROOM_LIST_LOADED = 'SPACES_ROOM_LIST_LOADED';

export const SPACES_FAVOURITES_LOADING = 'SPACES_FAVOURITES_LOADING';
export const SPACES_FAVOURITES_LOADED = 'SPACES_FAVOURITES_LOADED';
export const SPACES_FAVOURITES_FAILED = 'SPACES_FAVOURITES_FAILED';

export const SPACES_ROOM_GET_LOADING = 'SPACES_ROOM_GET_LOADING';
export const SPACES_ROOM_GET_FAILED = 'SPACES_ROOM_GET_FAILED';
export const SPACES_ROOM_GET_LOADED = 'SPACES_ROOM_GET_LOADED';

export const SPACES_OUTAGE_LIST_LOADING = 'SPACES_OUTAGE_LIST_LOADING';
export const SPACES_OUTAGE_LIST_FAILED = 'SPACES_OUTAGE_LIST_FAILED';
export const SPACES_OUTAGE_LIST_LOADED = 'SPACES_OUTAGE_LIST_LOADED';

export const SPACES_OUTAGE_ADDING = 'SPACES_OUTAGE_ADDING';
export const SPACES_OUTAGE_ADDED = 'SPACES_OUTAGE_ADDED';
export const SPACES_OUTAGE_ADD_FAILED = 'SPACES_OUTAGE_ADD_FAILED';

export const SPACES_OUTAGE_UPDATING = 'SPACES_OUTAGE_UPDATING';
export const SPACES_OUTAGE_UPDATED = 'SPACES_OUTAGE_UPDATED';
export const SPACES_OUTAGE_UPDATE_FAILED = 'SPACES_OUTAGE_UPDATE_FAILED';

export const SPACES_OUTAGE_DELETING = 'SPACES_OUTAGE_DELETING';
export const SPACES_OUTAGE_DELETED = 'SPACES_OUTAGE_DELETED';
export const SPACES_OUTAGE_DELETE_FAILED = 'SPACES_OUTAGE_DELETE_FAILED';

export const SPACES_NOTES_LIST_LOADING = 'SPACES_NOTES_LIST_LOADING';
export const SPACES_NOTES_LIST_FAILED = 'SPACES_NOTES_LIST_FAILED';
export const SPACES_NOTES_LIST_LOADED = 'SPACES_NOTES_LIST_LOADED';

export const SPACES_NOTE_ADDING = 'SPACES_NOTE_ADDING';
export const SPACES_NOTE_ADDED = 'SPACES_NOTE_ADDED';
export const SPACES_NOTE_ADD_FAILED = 'SPACES_NOTE_ADD_FAILED';

export const WEEKLYHOURS_LOADING = 'WEEKLYHOURS_LOADING';
export const WEEKLYHOURS_FAILED = 'WEEKLYHOURS_FAILED';
export const WEEKLYHOURS_LOADED = 'WEEKLYHOURS_LOADED';

export const SPACES_FACILITY_TYPE_LOADING = 'SPACES_FACILITY_TYPE_LOADING';
export const SPACES_FACILITY_TYPE_FAILED = 'SPACES_FACILITY_TYPE_FAILED';
export const SPACES_FACILITY_TYPE_LOADED = 'SPACES_FACILITY_TYPE_LOADED';

export const SPACES_FACILITY_TYPE_CREATING = 'SPACES_FACILITY_TYPE_CREATING';
export const SPACES_FACILITY_TYPE_CREATE_FAILED = 'SPACES_FACILITY_TYPE_CREATE_FAILED';
export const SPACES_FACILITY_TYPE_CREATED = 'SPACES_FACILITY_TYPE_CREATED';

export const SPACES_FACILITY_TYPE_UPDATING = 'SPACES_FACILITY_TYPE_UPDATING';
export const SPACES_FACILITY_TYPE_UPDATE_FAILED = 'SPACES_FACILITY_TYPE_UPDATE_FAILED';
export const SPACES_FACILITY_TYPE_UPDATED = 'SPACES_FACILITY_TYPE_UPDATED';

export const SPACES_FACILITY_TYPE_GROUP_CREATING = 'SPACES_FACILITY_TYPE_GROUP_CREATING';
export const SPACES_FACILITY_TYPE_GROUP_CREATED = 'SPACES_FACILITY_TYPE_GROUP_CREATED';
export const SPACES_FACILITY_TYPE_GROUP_CREATE_FAILED = 'SPACES_FACILITY_TYPE_GROUP_CREATE_FAILED';

export const SPACES_FACILITY_TYPE_GROUP_UPDATING = 'SPACES_FACILITY_TYPE_GROUP_UPDATING';
export const SPACES_FACILITY_TYPE_GROUP_UPDATE_FAILED = 'SPACES_FACILITY_TYPE_GROUP_UPDATE_FAILED';
export const SPACES_FACILITY_TYPE_GROUP_UPDATED = 'SPACES_FACILITY_TYPE_UPDATED';

export const SPACES_LOCATION_ADDING = 'SPACES_LOCATION_ADDING';
export const SPACES_LOCATION_ADDED = 'SPACES_LOCATION_ADDED';
export const SPACES_LOCATION_ADD_FAILED = 'SPACES_LOCATION_ADD_FAILED';
export const SPACES_LOCATION_ADD_CLEAR_ERROR = 'SPACES_LOCATION_ADD_CLEAR_ERROR';
export const SPACES_LOCATION_UPDATING = 'SPACES_LOCATION_UPDATING';
export const SPACES_LOCATION_UPDATED = 'SPACES_LOCATION_UPDATED';
export const SPACES_LOCATION_UPDATE_FAILED = 'SPACES_LOCATION_UPDATE_FAILED';
export const SPACES_LOCATION_CLEAR = 'SPACES_LOCATION_CLEAR';
export const SPACES_LOCATION_DELETING = 'SPACES_LOCATION_DELETING';
export const SPACES_LOCATION_DELETED = 'SPACES_LOCATION_DELETED';
export const SPACES_LOCATION_DELETE_FAILED = 'SPACES_LOCATION_DELETE_FAILED';
export const SPACES_LOCATION_DELETE_CLEAR_ERROR = 'SPACES_LOCATION_DELETE_CLEAR_ERROR';

// Sites
export const SPACES_CAMPUS_LIST_LOADING = 'SPACES_CAMPUS_LIST_LOADING';
export const SPACES_CAMPUS_LIST_LOADED = 'SPACES_CAMPUS_LIST_LOADED';
export const SPACES_CAMPUS_LIST_FAILED = 'SPACES_CAMPUS_LIST_FAILED';
export const SPACES_CAMPUS_LIST_CLEAR = 'SPACES_CAMPUS_LIST_CLEAR';
export const SPACES_CAMPUS_LIST_CLEAR_ERROR = 'SPACES_CAMPUS_LIST_CLEAR_ERROR';

export const SPACES_ARCHIBUS_TREE_LOADING = 'SPACES_ARCHIBUS_TREE_LOADING';
export const SPACES_ARCHIBUS_TREE_LOADED = 'SPACES_ARCHIBUS_TREE_LOADED';
export const SPACES_ARCHIBUS_TREE_FAILED = 'SPACES_ARCHIBUS_TREE_FAILED';

// Buildings
export const SPACES_BUILDING_LIST_LOADING = 'SPACES_BUILDING_LIST_LOADING';
export const SPACES_BUILDING_LIST_LOADED = 'SPACES_BUILDING_LIST_LOADED';
export const SPACES_BUILDING_LIST_FAILED = 'SPACES_BUILDING_LIST_FAILED';
export const SPACES_BUILDING_LIST_CLEAR = 'SPACES_BUILDING_LIST_CLEAR';
export const SPACES_BUILDING_LIST_CLEAR_ERROR = 'SPACES_BUILDING_LIST_CLEAR_ERROR';
// Floors
export const SPACES_FLOOR_LIST_LOADING = 'SPACES_FLOOR_LIST_LOADING';
export const SPACES_FLOOR_LIST_LOADED = 'SPACES_FLOOR_LIST_LOADED';
export const SPACES_FLOOR_LIST_FAILED = 'SPACES_FLOOR_LIST_FAILED';
export const SPACES_FLOOR_LIST_CLEAR = 'SPACES_FLOOR_LIST_CLEAR';
export const SPACES_FLOOR_LIST_CLEAR_ERROR = 'SPACES_FLOOR_LIST_CLEAR_ERROR';

export const SPACES_BULK_FACILITIES_SAVING = 'SPACES_BULK_FACILITIES_SAVING';
export const SPACES_BULK_FACILITIES_SAVED = 'SPACES_BULK_FACILITIES_SAVED';
export const SPACES_BULK_FACILITIES_SAVE_FAILED = 'SPACES_FAVOURITES_SAVE_FAILED';
