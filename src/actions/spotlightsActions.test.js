...
describe('Spotlight list actions', () => {
    ...
    describe('Spotlight Update', () => {
        it('handles a successful spotlight save request', async () => {
            ...
            await mockActionsStore.dispatch(
                saveSpotlightChange({ ...sendSpotlightRecord, id: '88888-d62b-11e7-954e-57c2cc19d151' }),
            );
            expect(mockActionsStore.getActions()).toHaveDispatchedActions(expectedActions);
        });
        it('handles a failing spotlight save request', async () => {
            ...
            try {
                await mockActionsStore.dispatch(saveSpotlightChange({ ...sendSpotlightRecord, id: 'id' }));
            } catch (e) {
                expect(mockActionsStore.getActions()).toHaveDispatchedActions(expectedActions);
            }
        });
