...
describe('Account action creators', () => {
    ...
    it('handles an exams get request', async () => {
        mockApi.onGet(repositories.routes.EXAMS_SUGGESTION_API('FREN1010').apiUrl).reply(200, {});
    ...
    it('dispatches expected actions when possible exams call fails', async () => {
        mockApi.onGet(repositories.routes.EXAMS_SUGGESTION_API('FREN1')).reply(500);
