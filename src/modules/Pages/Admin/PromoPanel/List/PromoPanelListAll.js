...
export const PromoPanelListAll = ({
    panelList,
    title,
    canEdit,
    canClone,
...
PromoPanelListAll.defaultProps = {
...
export default PromoPanelListAll;
