...
describe('PrinterTemplates', () => {
    ...
    // it('setIsEditing disables and re-enables the action button in edit dialog', async () => {
    //     const { getByTestId, getByText } = setup();
    ...
    //     await act(async () => {
    //         fireEvent.click(getByTestId('action_cell-1-edit-button'));
    //     });

    //     await waitFor(() => {
    //         expect(getByTestId('mock-placeholder-editor')).toBeInTheDocument();
    //     });

    //     expect(getByTestId('update_dialog-action-button')).not.toHaveAttribute('disabled');

    //     await act(async () => {
    //         fireEvent.click(getByTestId('mock-placeholder-editor-start-editing'));
    //     });

    //     expect(getByTestId('update_dialog-action-button')).toHaveAttribute('disabled');

    //     await act(async () => {
    //         fireEvent.click(getByTestId('mock-placeholder-editor-stop-editing'));
    //     });

    //     expect(getByTestId('update_dialog-action-button')).not.toHaveAttribute('disabled');
    // });

    // it('identifiers autocomplete in edit dialog triggers option callbacks', async () => {
    //     const { getByTestId, getByText, queryByRole, getAllByRole } = setup();
    ...
    //     const identifiersInput = getByTestId('identifiers-input');

    //     // mouseDown is how MUI opens the Autocomplete popup
    //     await act(async () => {
    //         fireEvent.mouseDown(identifiersInput);
    //     });

    //     // If the listbox opened, options are rendered and getOptionLabel/isOptionEqualToValue are called
    //     const listbox = queryByRole('listbox');
    //     if (listbox) {
    //         const options = getAllByRole('option');
    //         expect(options.length).toBeGreaterThan(0);
    //     } else {
    //         // Fallback: type to trigger filterOptions which calls getOptionLabel
    //         await act(async () => {
    //             fireEvent.change(identifiersInput, { target: { value: 'P' } });
    //         });
    //     }

    //     expect(identifiersInput).toBeInTheDocument();
    // });
