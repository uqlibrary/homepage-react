...
describe('hooks', () => {
    it('useLocation operates correctly with defaults', () => {
    ...
    it('should initialize useForm with default values', () => {
    ...
    it('useObjectList should initialize with an empty list', () => {
    ...
    it('useObjectList should initialize with provided list and transform', () => {
        ...
        const transform = list => {
            return list.map(item => ({ ...item, transformed: true }));
        };
        const { result } = renderHook(() => useObjectList(initialList, transform));
        const expectedTransformedList = initialList.map(item => ({ ...item, transformed: true }));
    ...
    it('useConfirmationAlert should initialize with default values', () => {
    ...
    it('useConfirmationAlert should open confirmation alert with error message', () => {
