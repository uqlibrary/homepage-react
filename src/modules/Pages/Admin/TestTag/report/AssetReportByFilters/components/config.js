...
import { createLocationLinkGridCell } from '../../../helpers/helpers';
    ...
    fields: {
        ...
        location: {
            fieldParams: {
                ...
                renderCell: params => createLocationLinkGridCell(renderLocation(params.row), params.row.floor_plan_url),
            },
        },
