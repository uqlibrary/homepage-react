...
export const createAppRootSx = (appTheme, footerHeight) => ({
    ...
    '--art-trail-font-size': `${appTheme.typography.artTrail.fontSize}px`,
    '--art-trail-font-family': appTheme.typography.artTrail.bodyFontFamily,
    '--art-trail-spacing': `${appTheme.typography.artTrail.fontSize}px`,
    '--art-trail-content-bottom-padding': `${appTheme.typography.artTrail.fontSize * 1}px`,
    minHeight: '100vh',
    height: '100dvh',
...
export const createGlobalStyles = appTheme => ({
    h1: {
        ...
        lineHeight: 1.2,
        fontFamily: appTheme.typography.artTrail.headingFontFamily,
    },
    h2: {
        fontSize: '2rem',
        fontWeight: appTheme.typography.heavy,
    ...
    div: {
        ...
        lineHeight: 1.5,
        fontFamily: appTheme.typography.artTrail.bodyFontFamily,
    },
    p: {
        fontSize: '1rem',
        fontWeight: appTheme.typography.fontWeightMedium,
