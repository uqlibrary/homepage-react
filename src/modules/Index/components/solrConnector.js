...
class SolrConnector extends Component {
    ...
    doSearch(searchParams) {
        if (searchParams.query) {
            ...
            const params = Object.assign({ wt: 'json' }, searchParams.highlightParams);
            const solrParams = {
    ...
    render() {
        ...
        const clones = React.Children.map(this.props.children, child => React.cloneElement(child, { solrConnector }));
