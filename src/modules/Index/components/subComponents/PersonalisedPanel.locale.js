export const ppLocale = {
    ...
    items: {
        ...
        loans: {
            ...
            url: 'https://search.library.uq.edu.au/primo-explore/account?vid=61UQ&section=loans&lang=en_US&targetURL=https://search.library.uq.edu.au/primo-explore/account?vid=61UQ&section=overview',
        },
        fines: {
            label: 'Manage your library fines ($[fines])',
            tooltip: 'Click to manage your library fines',
            url: 'https://search.library.uq.edu.au/primo-explore/account?vid=61UQ&section=fines&lang=en_US&targetURL=https://search.library.uq.edu.au/primo-explore/account?vid=61UQ&section=overview',
        },
        eSpacePossible: {
