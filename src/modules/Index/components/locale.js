...
export default {
    ...
    LibraryServices: {
        links: [
            {
                id: 'servicesforcommunity',
                title: 'Services for community',
                url: 'https://web.library.uq.edu.au/library-services/services-for-community',
            },
            {
                id: 'servicesforhdrs',
                title: 'Services for HDR students',
                url: 'https://web.library.uq.edu.au/library-services/services-higher-degree-by-research',
            },
            {
                id: 'servicesforhospital',
            ...
            },
            {
                id: 'ithelp',
                title: 'IT Help',
                url: 'https://web.library.uq.edu.au/library-services/it',
            },
            {
