...
export const PREMASQUERADE_SESSION_COOKIE_NAME = 'UQLID_PREMASQUERADE'; // what the uqlid value was before a masquerade session was started - must match value on reusable
